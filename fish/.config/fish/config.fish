...
abbr -a git-jobb 'git config user.name "krola1"; git config user.email "kwl082024@gmail.com"'

# Bytt repo til PRIVAT-identitet
abbr -a git-priv 'git config user.name "kwlbandit"; git config user.email "lars.wbk@pm.me"'
